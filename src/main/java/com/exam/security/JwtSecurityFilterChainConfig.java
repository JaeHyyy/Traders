...
public class JwtSecurityFilterChainConfig {
	    ...
	    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, HandlerMappingIntrospector introspector) throws Exception {
	        ...
	        return httpSecurity
	                ...
	                auth.antMatchers("/","/signup","/login","/success","/users","/hello","/home", "/home/{keyword}","/receipt","/api/qrcode","/ordercart","/home/save","/images/items/{filename}","/images/**").permitAll()  // 회원가입 요청 허용.
